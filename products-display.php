...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-sm-10 bg-light">
            ...
            $query = "SELECT COUNT(*) AS id FROM producttb";
            $result = mysqli_query($db, $query);
            $row = mysqli_fetch_array($result, MYSQLI_ASSOC);
            $total = $row['id'];
            $pages = ceil($total / $limit);

            $query1 = "SELECT * FROM producttb ";
                ...
                <div class="table table-responsive">
                    <table class="table table-striped w-100">
                        ...
                        <tr>
                            ...
                            <th class="text-left">Price befory</th>
                            <th class="text-left">Image</th>

                            <th class="text-left">Edite</th>
                        ...
                        <?php while($row1 = mysqli_fetch_array($result1, MYSQLI_ASSOC)){ ?>
                            <tr>
                                <form  method="post" id="the-form" enctype="multipart/form-data">
                                    <td><input type="text"  class="form-control" id="pid" name ="pid" value="<?php echo($row1['id']);  ?>" readonly></td>
                                    <td><input type="text" class="form-control" name ="product-name" value="<?php echo($row1['product_name']); ?>"></td>

                                    <td><input type="text" class="form-control" name ="brand" value="<?php echo($row1['product_price']); ?>"></td>
                                    <td><input type="text" class="form-control" name ="price" value="<?php echo($row1['product_befor_price']); ?>"></td>
                                    <td><input type="text" class="form-control" name ="quantity" value="<?php echo($row1['product_image']); ?>"></td>
